...
<html lang="en" class="light-style layout-menu-fixed" dir="ltr" data-theme="theme-default" data-assets-path="{{ asset('assets') }}/">
  <head>
    ...
    .card { 
        ...
        border-radius: 0.75rem; /* Lebih membulat sedikit agar modern */
        transition: all 0.3s ease-in-out;
    }

    /* 2. Hover Effect untuk Card Stats & Welcome Card */
    ...
    /* 5. Tabel - Zebra Striping & Tipografi */
    .table thead th { 
    ...
    /* 7. Custom Scrollbar (Biar makin pro) */
    ::-webkit-scrollbar {
        width: 6px;
        height: 6px;
    }
    ...
    /* 8. Animasi Fade In saat buka Page */
    @keyframes fadeIn {
                            ...
                            <div class="table-responsive text-nowrap">
                                <table class="table table-hover align-middle">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div>
                                                        ...
                                                        <small class="text-muted">{{ \Carbon\Carbon::parse($item->tanggal)->translatedFormat('d M Y') }}</small>
                                                    </div>
                                                </div>
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                <div class="d-flex flex-column">
                                                    <span class="fw-semibold text-dark small">{{ $item->user->name ?? 'System' }}</span>
                                                    @php
                                                        $roleColor = (strtolower($item->user->role ?? '') == 'admin') ? 'bg-label-danger' : 'bg-label-primary';
                                                    @endphp
                                                    <span class="badge {{ $roleColor }} badge-role w-px-50" style="width: fit-content;">
                                                        {{ $item->user->role ?? 'User' }}
                                                    </span>
                                                </div>
                                            </td>
                                        ...
                                        @empty
                                        <tr>
                                          <td colspan="5" class="text-center py-5 text-muted small">Belum ada transaksi tersimpan.</td>
                                        </tr>
                                        @endforelse
                                    </tbody>
                                </table>
